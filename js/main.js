                ...
                if (item.initialState !== null) {
                    ...
                    switch (item.mode) {
                        ...
                        case 4:
                            ...
                            if (
                                Math.ceil(bottom) >=
                                document.body.scrollHeight - pad
                            )
            ...
            var _this = this,
                ...
                stagger =
                    "stagger" in settings
                        ...
                        : false,
                staggerOrder =
                    "staggerOrder" in settings
                        ? settings.staggerOrder
                        : "default",
                staggerSelector =
                    "staggerSelector" in settings
            ...
            switch (effect.type) {
                ...
                case "transition":
                    ...
                    enter = function (children, staggerDelay = 0) {
                        ...
                        _this.style.transition = effect.transition.apply(
                            _this,
                            [speed / 1000, (delay + staggerDelay) / 1000]
                        );
